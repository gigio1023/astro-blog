...
- Computer use -> virtual machines provided by OpenAI (fine-tuned model, pricing TBD).
...
Similar to LangChain, there is the concept of a runnable object, though usage slightly differs. The primary interaction is through a .run method.
	-	Runners: Bundle and execute one or more agents in a loop.
	-	Capable of generating responses for a single turn.

## Streaming
Event types are defined in [here](https://openai.github.io/openai-agents-python/ref/stream_events/), using `Literal` not Enum.
